...
@Component({
  selector: 'app-grafico-publicaciones',
  templateUrl: './grafico-publicaciones.component.html',
  styleUrls: ['./grafico-publicaciones.component.css']
})
export class GraficoPublicacionesComponent implements OnInit {
  ...
  obtenerPublicacionesFecha() {
    ...
    this.donacionesService
      .publicacionesGraficFecha(fechaInicioDate, fechaFinDate)
      .subscribe((data) => {
        this.publicaciones = data.data;
        console.log(this.publicaciones);
        this.updateChart();
      ...
      if (ctx) {
        ...
        this.myChart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
              {
                label: 'Publicaciones por tipo de animal',
                data: values,
                borderWidth: 1,
